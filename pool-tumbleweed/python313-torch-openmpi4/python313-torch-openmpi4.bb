...
RPM_NAME = "python313-torch-openmpi4-2.13.0-1.2.aarch64.rpm"
RPM_HASH = "35a4f95dd7c58a463fe97465c4b972b6e9ddac1e572c0252c056b03158f4101d9f0178574ae325c780a472db7a583a4d4ea5ec10efe03006ecf0721dc85cdca4"

RPROVIDES:${PN} += "libshm.so \
libtorch-global-deps.so \
libtorch-python.so \
python3-caffe2-openmpi4 \
python3-pytorch-openmpi4 \
python3-torch-openmpi4 \
python3.13dist-torch \
python313-caffe2-openmpi4 \
python313-pytorch-openmpi4 \
python313-torch-openmpi4 \
python3dist-torch"
