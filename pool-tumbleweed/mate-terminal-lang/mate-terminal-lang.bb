...
locale-mate-terminal-es-CL \
locale-mate-terminal-es-CO \
locale-mate-terminal-es-ES \
locale-mate-terminal-es-MX \
locale-mate-terminal-es-PR \
locale-mate-terminal-et \
locale-mate-terminal-eu \
locale-mate-terminal-fa \
locale-mate-terminal-fi \
locale-mate-terminal-fr \
locale-mate-terminal-fr-CA \
...
locale-mate-terminal-zh-CN \
locale-mate-terminal-zh-HK \
locale-mate-terminal-zh-TW \
mate-terminal-lang \
