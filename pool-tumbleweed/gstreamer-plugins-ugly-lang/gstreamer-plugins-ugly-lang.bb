...
RPM_NAME = "gstreamer-plugins-ugly-lang-1.28.7-1.1.noarch.rpm"
RPM_HASH = "18d90c5912c74b79877907add94fb2fe1591920678d389e18506184432a3e43c8503ca6c7520c3cc53d7d3aeb18f8166eb4aa4a70b50506f55e2dcd30865838f"
REPO_ARCH = "noarch"

RPROVIDES:${PN} += "gstreamer-plugins-ugly-lang \
gstreamer-plugins-ugly-lang-all \
locale-gstreamer-plugins-ugly-af \
locale-gstreamer-plugins-ugly-ar \
...
locale-gstreamer-plugins-ugly-kk \
