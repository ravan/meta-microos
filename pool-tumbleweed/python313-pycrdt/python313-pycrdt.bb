...
RPM_NAME = "python313-pycrdt-0.12.50-1.7.aarch64.rpm"
RPM_HASH = "8e85d450bc03d0464cfab01ba2e480344cf661530912f292fccf2407f7fa27e687159fd0b011032d08b8be7c77680451df5c5a3d1d05fd8ff77c364c8e2ac275"

RPROVIDES:${PN} += "python3-pycrdt \
python3.13dist-pycrdt \
python313-pycrdt \
python3dist-pycrdt"

RDEPENDS:${PN} += "-python313-anyio >= 4.4 with python313-anyio < 5 \
libc.so.6 \
libgcc-s.so.1 \
python-abi"
