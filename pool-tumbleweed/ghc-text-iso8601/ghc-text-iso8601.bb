...
DESCRIPTION = "Converting time to and from IS0 8601 text. Specifically the \
[RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) profile."
LICENSE = "BSD-3-Clause"

PV = "0.1.1.1"

RPM_NAME = "ghc-text-iso8601-0.1.1.1-1.3.aarch64.rpm"
RPM_HASH = "fd2b4826d492a95e548cc43ea01fc211d8d525a6ae85b89ad7f2c0dc9280846180063a56ec44ebe5c8605accda6e3bfc98fabe613de3c0a52170d561178dfb3c"

RPROVIDES:${PN} += "ghc-text-iso8601 \
