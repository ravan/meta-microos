...
RPM_NAME = "ghc-ShellCheck-0.11.0-1.3.aarch64.rpm"
RPM_HASH = "945494676e0846a2a23c0605203d328d6fd7fad87d54a1201f01a0755807bc706429a8a099187b8dd279143610eb6d30866a96294dbe242fb8136ebe1cec1eb7"

RPROVIDES:${PN} += "ghc-ShellCheck \
libHSShellCheck-0.11.0-9WjU3BJUXC1EFIs8EzczE8-ghc9.12.4.so"

RDEPENDS:${PN} += "libHSDiff-1.0.2-5PTxq8P0tjM13opDjMQ0ap-ghc9.12.4.so \
