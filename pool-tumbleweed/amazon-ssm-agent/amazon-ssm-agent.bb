...
bundled-golang(github.com/Workiva/go-datastructures) \
bundled-golang(github.com/aws/aws-sdk-go) \
bundled-golang(github.com/carlescere/scheduler) \
bundled-golang(github.com/cenkalti/backoff) \
...
bundled-golang(github.com/gabs) \
bundled-golang(github.com/go-git/gcfg) \
bundled-golang(github.com/go-git/go-billy) \
bundled-golang(github.com/go-git/go-git) \
bundled-golang(github.com/go-github) \
bundled-golang(github.com/go-ini/ini) \
bundled-golang(github.com/go-yaml/yaml) \
bundled-golang(github.com/google/go-querystring) \
bundled-golang(github.com/google/shlex) \
bundled-golang(github.com/gorhill/cronexpr) \
bundled-golang(github.com/gorilla/websocket) \
bundled-golang(github.com/hectane/go-acl) \
...
bundled-golang(github.com/kevinburke/ssh-config) \
bundled-golang(github.com/lsegal/gucumber) \
bundled-golang(github.com/mitchellh/go-homedir) \
bundled-golang(github.com/mitchellh/go-ps) \
bundled-golang(github.com/nightlyone/lockfile) \
bundled-golang(github.com/pborman/ansi) \
bundled-golang(github.com/pmezard/go-difflib) \
bundled-golang(github.com/sergi/go-diff) \
bundled-golang(github.com/shiena/ansicolor) \
bundled-golang(github.com/stretchr/objx) \
bundled-golang(github.com/stretchr/testify) \
bundled-golang(github.com/twinj/uuid) \
bundled-golang(github.com/xanzy/ssh-agent) \
bundled-golang(github.com/xtaci/smux) \
bundled-golang(go.nanomsg.org/mangos) \
